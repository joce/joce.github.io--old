...
:sparkles: :+1: :pizza: :smile: :ice_cream: :sparkles:
...
<div class="side-by-side">
    <div class="toleft">
        <figure>
            <img class="image" src="{{ site.url }}/assets/images/2015-02-24-markdown-extra-components-1.jpg" alt="Alt Text">
            <figcaption class="caption">Photo by <a href="https://pixabay.com/en/users/DzidekLasek-1329146/">DzidekLasek</a></figcaption>
        </figure>
    </div>
